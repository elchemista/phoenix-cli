...
With Phoenix 1.8, the framework has become intentionally minimal. While the core architecture is excellent, some essentials (like dialogs, common UI components) are no longer included.
